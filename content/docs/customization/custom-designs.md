---
title: "Custom Designs & Micro-Widgets"
description: "Design spatial micro-widgets with dynamic variable interpolation."
weight: 3
...
|---|---|
| `{notif.title}` | Original notification title |
| `{notif.text}` | Body text of the notification |

...
description: "Explore all features and modules provided by Hyper Bridge."
icon: "list-check"
weight: 50
...
- **[Smart Actions]({{< ref "smart-actions.md" >}})**: Contextual 1-tap actions for two-factor authentication OTPs, parcel tracking, addresses, and call actions.
